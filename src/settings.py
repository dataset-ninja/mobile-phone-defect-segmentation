...
##################################
PROJECT_NAME: str = "MSD"
PROJECT_NAME_FULL: str = "MSD: Mobile Phone Defect Segmentation Dataset"
...
RELEASE_DATE: Optional[str] = "2021-07-28"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://github.com/jianzhang96/MSD"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 6762419
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/mobile-phone-defect-segmentation"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://github.com/jianzhang96/MSD#download"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = "https://ieeexplore.ieee.org/abstract/document/9747311"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {"__PRETEXT__":"Additionally, images without defects are marked with ***good*** tag"}
